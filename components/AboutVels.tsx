  ...
  return (
    <section className="relative w-full overflow-hidden bg-white py-8 sm:py-10 md:py-12 lg:py-14">
      ...
      <div className="relative z-10 mx-auto max-w-[760px] px-5 text-center sm:px-6">
        ...
        <div className="mx-auto mt-4 h-[1.5px] w-full max-w-[640px] bg-[#4d56c9]" />
        ...
        <div className="mx-auto mt-9 max-w-[680px] space-y-4 text-[13px] font-normal leading-[1.35] text-[#555555] sm:text-[14px] md:text-[15px]">
          <p>
            ...
            <span className="font-bold text-[#2b2f91]">33 years</span> in
            education, committed to providing quality education and fostering
            innovation. Currently, the VELS Group comprises{" "}
            <span className="font-bold text-[#2b2f91]">54 Institutions</span>,{" "}
            <span className="font-bold text-[#2b2f91]">34 campuses</span>,{" "}
            <span className="font-bold text-[#2b2f91]">7,700 staff</span>, and
            student population exceeding{" "}
            <span className="font-bold text-[#2b2f91]">51,000</span>.
          </p>
